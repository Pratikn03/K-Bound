...
REC = ROOT / "experiments/kbound/results/camelyon17_richZ_F_v1/result_884129ba.json"
AFP = ROOT / "docs/research/kbound/scripts/analyze_F.py"
...
out = {"source": str(REC), "candidate": "eata_online", "estimator": "gbr",
...
OUTP = ROOT / "audits/integrity_2026-06-20/camelyon_reconciliation/recon_results.json"
