...
def build_plan(
    *,
    ...
    steps: list[Step] = [
        ...
        Step(
            name="prep_mvtec_patchcore_supervised_paired",
            group="paper_prep",
            command=(
                py,
                "src/scripts/prepare_mvtec3d_fusion_benchmark.py",
                ...
                "--supervised-paired",
                "--output",
                "experiments/fusion/mvtec3d_patchcore_supervised_paired_inputs.csv",
                "--metadata",
                "experiments/fusion/mvtec3d_patchcore_supervised_paired_metadata.json",
            ),
            required_paths=("data/raw/mvtec3d",),
            description="Build the public MVTec PatchCore supervised-paired protocol variant.",
        ),
        Step(
            name="prep_mvtec_patchcore_heldout",
            group="paper_prep",
            command=(
                py,
                "src/scripts/prepare_mvtec3d_fusion_benchmark.py",
                ...
                "42",
                "--output",
                "experiments/fusion/mvtec3d_patchcore_heldout_inputs.csv",
                "--metadata",
                "experiments/fusion/mvtec3d_patchcore_heldout_metadata.json",
            ),
            required_paths=("data/raw/mvtec3d",),
            description="Build the public MVTec PatchCore held-out-category protocol variant.",
        ),
        Step(
        ...
        Step(
            name="train_mvtec_patchcore_supervised_paired",
            group="paper_train",
            command=(
                py,
                "src/scripts/run_breakthrough_experiment.py",
                ...
                "--output",
                "experiments/fusion/mvtec3d_patchcore_supervised_paired_results.json",
            ),
            required_paths=("experiments/fusion/mvtec3d_patchcore_supervised_paired_inputs.csv",),
            description="Run the 5-seed public MVTec PatchCore supervised-paired experiment.",
        ),
        Step(
            name="train_mvtec_patchcore_heldout",
            group="paper_train",
            command=(
                py,
                "src/scripts/run_breakthrough_experiment.py",
                ...
                "--output",
                "experiments/fusion/mvtec3d_patchcore_heldout_results.json",
            ),
            required_paths=("experiments/fusion/mvtec3d_patchcore_heldout_inputs.csv",),
            description="Run the 5-seed public MVTec PatchCore held-out-category experiment.",
        ),
        Step(
