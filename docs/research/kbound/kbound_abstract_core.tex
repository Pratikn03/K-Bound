...
Furthermore, an evidence-fibre audit theorem characterizes the smallest residual bound that
any uniformly valid audit based on the same observable law must cover at its declared confidence level;
additional processing of unchanged evidence cannot reduce the unresolved residual range. Addressing this problem under a complementary inductive
