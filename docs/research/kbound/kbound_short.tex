...
Domain-gen.\ natural & PACS (4 LODO splits) & no-harm or abstain & completed 3-seed null diagnostic \\
...
Weak evidence & ImageNet-R, CIFAR-10.1 & abstain / conservative & completed diagnostics; no promoted win \\
...
PACS (LODO) & source-domain cells & LOO jackknife $q_{0.9}$ & $18$ cells/target/seed; $3$ seeds \\
...
PACS & $3$ seeds $\times4$ LODO targets $\times18$ cells & mean regret $0.0431/0.0176/0.0446$; reported mean $\mathrm{FA}_{\mathrm u}=0.0093$ (pooled count not retained) & conservative/null action-safety diagnostic & locked diagnostic null; no beats-both claim \\
ImageNet-R D & $4$ seeds $\times10$ backbones $\times12$ conditions & mean-across-backbone regret $0.0112/0.0064/0.0325$; observed $\mathrm{FA}_{\mathrm u}=1/480$ & candidate-dependent fixed-policy tracking; $0/10$ CI beats-both & locked diagnostic null \\
...
structural non-identifiability. PACS is complete at three seeds but remains a null diagnostic.
...
PACS and ImageNet-R are completed, locked null diagnostics; CIFAR-10.1 is a locked diagnostic fail.
