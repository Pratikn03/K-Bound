...
exposure. A separate retrospective mixed-sign Camelyon17 diagnostic (\KBSuppRef{app:camelyon17}{Appendix}{B.5}) contains both helpful and harmful adaptation cells and shows nontrivial ADAPT/FREEZE/ABSTAIN exposure with lower measured point regret than both fixed policies; because the target was already opened, it is treated as diagnostic rather than prospective confirmation. These candidate-specific outcomes do not demonstrate prospective selective routing.
