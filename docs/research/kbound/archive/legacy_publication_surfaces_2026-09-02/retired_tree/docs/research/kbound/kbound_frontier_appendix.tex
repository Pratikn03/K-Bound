...
%% fix-queue item 32: \resizebox{\columnwidth}{!} dropped -- five short numeric columns fit
%% at \footnotesize in one IEEEtran column; the wrapper only rescaled the glyphs.
...
\kbgraphics[width=0.72\linewidth]{figures/app_frontier_cifar10c.png}
...
%% fix-queue item 32: \resizebox{\columnwidth}{!} dropped. The long first column is what made
%% this table wide, so it is set at \scriptsize with abbreviated heads rather than rescaled.
\setlength{\tabcolsep}{3.5pt}
{%
\begin{tabular}{lcccc}
\toprule
decision rule (SAR, harmful regime) & false-adapt & harmful-ad. & regret $\downarrow$ & cov. \\
\midrule
...
\begin{figure}[tb]\centering
\kbgraphics[width=0.92\linewidth]{figures/app_frontier_imagenetc.png}
