...
def build_report(*, run_validators: bool = False) -> dict[str, Any]:
    ...
    return {
        ...
        "papers": {
            "short": "docs/research/kbound/kbound_short_final_draft.pdf",
            "long": "docs/research/kbound/kbound_tmlr.pdf",
            "word": "docs/research/kbound/kbound_short_final_draft.docx",
        },
        "reproduce": "docs/research/kbound/runbooks/release_candidate.sh",
