...
> **SUPPLEMENT SOURCE — the protocol and pending main tables are already folded
> into `kbound_short.tex`.**
...
>
> Keep numerical cells pending until generated from a publication-gate-passing run.
