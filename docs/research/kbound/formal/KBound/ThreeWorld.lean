...
The full Gaussian sample-complexity proof lives in
`theory_v2/tight_constants_closure.tex`; this module records the identifiability
link used by the multicandidate layer.
-/
