"""Experimental betting e-process for adaptation gating.

The anytime interpretation is conditional on the predictability, boundedness,
and supermartingale assumptions below. The short paper does not promote an
anytime empirical claim or a full foundational mechanization of this layer.
...
class EProcess:
    """Online betting e-process for adaptation gating.
