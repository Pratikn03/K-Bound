...
def registered_formal_scope() -> dict[str, Any]:
    ...
    if not layers or positive + counterexamples != len(layers):
        raise ValueError("Dashboard cannot interpret an unknown foundational layer status")
    return {
    ...
    return {
        ...
        "evidence_strip": {
            ...
            "open_theory": {
                ...
                "sub": "The unrestricted orbit-only claim is refuted; conditional extensions do not establish unrestricted sufficiency.",
            },
