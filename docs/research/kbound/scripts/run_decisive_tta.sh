...
echo ""
echo " These outputs are diagnostic; completion does not establish publication eligibility."
echo " Next: verify identities, protocol, calibration, and claims before manuscript integration."
echo " For a reviewed, clean release: bash docs/research/kbound/runbooks/release_candidate.sh all"
echo "=============================================================="
