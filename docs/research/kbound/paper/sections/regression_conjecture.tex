...
\begin{proposition}[Noise-invariance of the regression decision]\label{thm:reg-noise}
...
\begin{proposition}[Bounded-drift knowability boundary; exact characterization]\label{thm:reg-iff}
...
\[
\begin{aligned}
U &=\E_T\!\big[(f_0-f_a)(f_0+f_a)\big],\\
T_S &=\E_T\!\big[(f_0-f_a)\,g_S\big],\\
...
Proposition~\ref{thm:reg-noise}) gives the displayed decomposition. H\"older yields
...
\includegraphics[width=0.92\linewidth]{figures/fig_regression_boundary.png}
\caption{The bounded-drift knowability boundary (Proposition~\ref{thm:reg-iff}). Left:
the decision target $\Delta$ is invariant to unknown label noise while cardinal risks
are confounded (Proposition~\ref{thm:reg-noise}). Right: identifiability holds exactly
...
\paragraph{Weight (honest).} Proposition~\ref{thm:reg-iff} is, to our knowledge, the first
