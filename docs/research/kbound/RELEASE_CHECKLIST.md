...
variants) as current deliverables. Their original bytes and disposition remain available in the
[`stale_publication_builds_2026-09-02` archive](archive/stale_publication_builds_2026-09-02/README.md).
