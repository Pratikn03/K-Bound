...
IRp = json.load(open(KB_REPO_ROOT + "/experiments/kbound/results/imagenetr_kbound_light_mps_internal/_partial.json"))
IR1 = json.load(open(KB_REPO_ROOT + "/experiments/kbound/results/imagenetr_kbound_1pct_mps_internal/result_604f04ba.json"))
