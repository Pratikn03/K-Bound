...
/Users/pratik_n/.venv_wilds/bin/python -u experiments/kbound/wilds/run_camelyon17_kbound.py \
...
/Users/pratik_n/.venv_wilds/bin/python -u docs/research/kbound/scripts/analyze_F.py \
  --records "$latest" \
