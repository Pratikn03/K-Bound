"""Boundary contracts for optional, noncanonical K-Bound source drivers."""
...
def _run_with_flag(name: str, value: str) -> subprocess.CompletedProcess[str]:
    ...
    for flag in ("BUILD_SHORT_MAIN", "BUILD_SHORT_SUPPLEMENT"):
...
def test_optional_split_drivers_preserve_their_input_boundaries() -> None:
