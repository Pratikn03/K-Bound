...
class TestBuildBehaviorFeatureTable:
    ...
    def test_basic_feature_table(self):
        ...
        df = pd.DataFrame(
            {
                "user": [1, 1, 2, 2],
                "date": ["2023-01-01 10:00", "2023-01-01 11:00", "2023-01-01 12:00", "2023-01-01 14:00"],
    ...
    def test_temporal_feature_extraction(self):
        ...
        df = pd.DataFrame(
            {
                "date": pd.to_datetime(["2023-01-01 10:30", "2023-01-02 14:45", "2023-01-03 18:15"]),
                "feature": [1, 2, 3],
                "Revenue": [0, 1, 0],
            }
        )
        ...
        df = pd.DataFrame(
            {
                "user": [1, 1, 1, 2, 2],
                "date": pd.to_datetime(
                    ["2023-01-01 10:00", "2023-01-01 10:05", "2023-01-01 10:10", "2023-01-01 11:00", "2023-01-01 11:10"]
                ),
                "Revenue": [0, 0, 1, 1, 0],
            }
        )
    ...
    def test_drop_columns(self):
        ...
        df = pd.DataFrame(
            {"id": [1, 2, 3], "timestamp_raw": ["a", "b", "c"], "feature": [1.0, 2.0, 3.0], "Revenue": [0, 1, 0]}
        )

        result = build_behavior_feature_table(df, drop_columns=["id", "timestamp_raw"])
    ...
    def test_without_time_column(self):
        ...
        df = pd.DataFrame({"feature1": [1.0, 2.0, 3.0], "feature2": [4.0, 5.0, 6.0], "Revenue": [0, 1, 0]})
...
class TestBehaviorFeaturesEdgeCases:
    ...
    def test_single_row(self):
        ...
        df = pd.DataFrame({"feature": [1.0], "date": ["2023-01-01 10:00"], "Revenue": [1]})
    ...
    def test_single_user(self):
        ...
        df = pd.DataFrame(
            {
                "user": [1, 1, 1],
                "date": pd.to_datetime(["2023-01-01 10:00", "2023-01-01 11:00", "2023-01-01 12:00"]),
                "Revenue": [0, 1, 0],
            }
        )
    ...
    def test_invalid_dates(self):
        ...
        df = pd.DataFrame(
            {"date": ["invalid", "2023-01-01", "also invalid"], "feature": [1, 2, 3], "Revenue": [0, 1, 0]}
        )
    ...
    def test_boolean_target(self):
        ...
        df = pd.DataFrame({"feature": [1, 2, 3], "Revenue": [True, False, True]})
    ...
    def test_duplicate_timestamps(self):
        ...
        df = pd.DataFrame(
            {
                "user": [1, 1, 1],
                "date": pd.to_datetime(["2023-01-01 10:00", "2023-01-01 10:00", "2023-01-01 11:00"]),
                "Revenue": [0, 1, 0],
            }
        )
