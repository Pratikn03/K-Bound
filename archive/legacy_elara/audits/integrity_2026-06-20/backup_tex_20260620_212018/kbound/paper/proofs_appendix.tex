...
\emph{Spike branch.} Let world$_-$ be the point mass at $-\kappa$ and world$_+$ place
...
$(1-p)^n\le2(\alpha+\beta)$, giving $np\ge\log\frac{1}{2(\alpha+\beta)}$ and
$\kappa=\tfrac{p}{2}(R/2+\kappa)\ge\tfrac{R}{4}\,\log\frac{1}{2(\alpha+\beta)}/n$.
\end{proof}
