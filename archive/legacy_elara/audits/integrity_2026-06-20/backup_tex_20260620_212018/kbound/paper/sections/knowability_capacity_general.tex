...
% ----------------------------------------------------------------------------
\subsection{Stage 2: exponential-family / MLR location families}\label{sec:gen-mlr}
% ----------------------------------------------------------------------------
We now leave the Gaussian and ask which \emph{non-Gaussian} location families keep
the matched threshold. Let $Q_X$ have a density $q_0(x-\mu)$ for a fixed base density
