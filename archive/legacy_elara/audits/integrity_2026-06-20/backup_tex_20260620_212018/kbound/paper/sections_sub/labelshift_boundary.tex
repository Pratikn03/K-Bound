...
\begin{theorem}[Label-shift knowability boundary]\label{thm:ls-iff}
...
\includegraphics[width=0.92\textwidth]{figures/fig_labelshift_boundary.png}
\caption{The label-shift boundary (Theorem~\ref{thm:ls-iff}). Left: injective evidence
