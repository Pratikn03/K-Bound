...
class KGA:
    ...
    alpha : float, default=0.1
        Operating miscoverage level. Under valid interval coverage, Theorem 3
        bounds marginal false-adapt and false-freeze probability.
    method : str, default='ebern'
        ...
        Theorem 3 default), ``'hoeffding'``, or experimental ``'evalue'``.
    ...
    def decide(self, certificate: Certificate | None = None) -> Decision:
        ...
        -------
        Decision
            ADAPT / FREEZE / ABSTAIN. Marginal error control is inherited only
            when the supplied certificate satisfies its coverage premise.
        """
